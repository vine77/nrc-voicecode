...
exp16 = "<<7 lines>>foo2<CURSOR>();"

utt17 = ['returning', 'some', 'pointer']
exp17 = "<<7 lines>>some* <CURSOR>foo2();"

utt18 = ['add', 'argument', 'integer', 'counter', 'comma', 'sum', 'of', 'type', 'int\\int']
exp18 = "<<7 lines>>some* foo2(int counter, int <CURSOR>sum);"

utt19 = ['after', 'semi']
exp19 = "<<7 lines>>some* foo2(int counter, int sum);<CURSOR>"

utt20 = ['new', 'paragraph']
exp20 = \
"""<<7 lines>>
some* foo2(int counter, int sum);
