...
;;         Taraz Buck <tebuck@cmu.edu>
;; Maintainer: Eric M. Ludlam <eludlam@mathworks.com>
;; Created: 04 Jan 91
;; Version: 2.3.2
;; Keywords: MATLAB
;;
;; Copyright (C) 2008 Taraz Buck
...
(defcustom matlab-keyword-list '("global" "persistent" "for" "while"
				 ...
				 "catch" "tic" "toc" "class" "properties" "methods" "events")
...
\\|for\\|global\\|if\\|otherwise\\|return\\|switch\\|try\\|while\\|tic\\|toc\\|class\\|properties\\|methods\\|events)\\>")
...
\\|return\\|switch\\|case\\|otherwise\\|try\\|catch\\|class\\|properties\\|methods\\|events\\)\\b" 2 keyword)))
...
(defconst matlab-block-beg-pre-if "function\\|for\\|while\\|if\\|switch\\|try\\|tic\\|class\\|properties\\|methods\\|events"
  "Keywords which mark the beginning of an indented block.
Includes function.")

(defconst matlab-block-beg-pre-no-if "for\\|while\\|if\\|switch\\|try\\|tic\\|class\\|properties\\|methods\\|events"
  "Keywords which mark the beginning of an indented block.
Excludes function.")
...
Travels across continuations."
  ...
  (let ((p nil)
	...
	(r (save-excursion
	     (re-search-backward
	      "^\\s-*\\(%\\|if\\|else\\(if\\)\\|while\\|for\\|class\\|properties\\|methods\\|events\\|$\\)\\>"
	      nil t))))
...
;;; Change log
;;; $Log: matlab.el,v $
;;; Revision 1.4.6.11  2008/08/24 19:56:00  tebuck
;;; Version number change (2.3.2).
;;; Added class, properties, methods, events to keyword list.
;;;
