...
#                        'CmdInterp.match_untranslated_text': 1,
#                        'SymbolConstruction.insert': 1,
#                        'SymbolConstruction.add': 1,
#                        'SymbolConstruction.reset': 1,
...
#                        'ActionSearchOrLookback': 1,
#                        'ActionSearch.execute': 1,
#                        'SymDict.init_from_file': 1,
#                        'SymDict.maybe_parse_standard_symbols': 1,
#                        'SymDict.changed_since_sym_file': 1,
#                        'wxMediator': 1,
...
#                        'create_update': 1,
#                        'StateStackBasic': 1,
#                        'StateStackBasic.check_stacks': 1,
#                        'SourceBuffWithDiffs': 1,
#                        'BufferStatesBasic': 1,
#                        'CmdInterp': 1,
#                        'SymDict': 1,
#                        'SymDict.remove_tentative_symbol': 1,
#                        'SymDict.remove_symbol': 1,
#                         'SymDict._remove_short_symbols': 1,
...
#                        'SourceBuffCached.get_pos_selection': 1,
#                        'SourceBuffMessaging._get_pos_selection_from_app': 1,
#                        'get_mess': 1,
#                        'sr_interface.connect': 1,
#                        'sr_interface.word_exists': 1,
...
#                      'CmdInterp.make_word_element': 1,
#                      'CmdInterp.interpret_phrase': 1,
#                      'BuildUnder.add_word': 1,
#                      'BuildUnder.add_letter': 1,
#                        'BuildInterCaps.add_word': 1,
#                      'ManualCaps.change_caps': 1,
#                      'ManualCaps.capitalization_state': 1,
#                      'FixedCaps.capitalization_state': 1,
#                      'SymBuilderFactory': 1,
#                      'SymBuilder.spoken_form': 1,
#                      'CmdInterp.interpret_NL_cmd': 1,
#                      'CmdInterp.match_untranslated_text': 1,
#                      'CmdInterp.chop_symbol_phrase': 1,
#                      'CmdInterp.is_spoken_symbol': 1,
#                      'SymDict._score': 1,
#                      'SymDict.accept_symbol_match': 1, 
#                      'SymDict.add_symbol': 1, 
#                      'SymDict.update_spoken_forms': 1,
#                      'SymDict.add_abbreviation': 1,
#                      'CmdInterp.dlg_select_symbol_match': 1,
#                      'CmdInterp.dlg_select_symbol_match.mismatch': 1,
#                      'CmdInterp.is_spoken_LSA': 1,
#                      'CmdInterp.is_spoken_CSC': 1,
#                      'CmdInterp.chop_construct': 1,
#                      'CmdInterp.chop_symbol': 1,
#                      'CmdInterp.chop_CSC': 1,
#                      'CmdInterp.chop_spoken_CSC': 1,
#                      'CmdInterp.add_lsa': 1,
#                       'CmdInterp.add_csc_set': 1,
#                       'CmdInterp.index_csc': 1,
#                      'sr_interface.addWord': 1,
#                      'SinglePunctuation.create': 1,
#                      'LeftRightPunctuation.create': 1,
#                      'PairedQuotes.create': 1,
#                      'synchronize': 1,
#                      'insert_indent': 1,
#                      'get_selection': 1,
#                      'set_selection': 1,
