...
#                        'ActionRepeatLastCmd.execute': 1,
#                        'ActionNavigateByPseudoCode': 1,
#                        'SelectWinGramNL.gotResultsObject': 1,
#                        'ContLastActionWas.applies': 1,
#                        'ActionRepeatBidirectCmd.execute': 1,
#                        'PunctuationSet._add_navigation': 1,
#                        'SinglePunctuation._add_single_navigation': 1, 
